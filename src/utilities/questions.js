...
export const VispdatRisksQuestions = fromJS({
  ...
  questions: [
    ...
    { question: 'Have you been attacked or beaten up since you’ve become homeless?', type: 'dropdown', answers: 'general' },
    { question: 'Have you threatened to or tried to harm yourself or anyone else in the last year?', type: 'dropdown', answers: 'general' },
    { question: 'Do you have any legal stuff going on right now that may result in you being locked up, having to pay fines, or that make it more difficult to rent a place to live?', type: 'dropdown', answers: 'general' },
    { question: 'Does anybody force or trick you to do things that you do not want to do?', type: 'dropdown', answers: 'general' },
    { question: 'Do you ever do things that may be considered to be risky like exchange sex for money, run drugs for someone, have unprotected sex with someone you don’t know, share a needle, or anything like that?', type: 'dropdown', answers: 'general' }
  ]
});
...
export const VispdatSocializationQuestions = fromJS({
  ...
  prefaceText: '',
  questions: [
    { question: 'Is there any person, past landlord, business, bookie, dealer, or government group like the IRS that things you owe them money?', type: 'dropdown', answers: 'general' },
    { question: 'Do you get any money from the government, a pension, an inheritance, working under the table, a regular job, or anything like that?', type: 'dropdown', answers: 'general' },
    { question: 'Do you have planned activities, other than just surviving, that make you feel happy and fulfilled?', type: 'dropdown', answers: 'general' },
    { question: 'Are you currently able to take care of basic needs like bathing, changing clothes, using a restroom, getting food and clean water and other things like that?', type: 'dropdown', answers: 'general' },
    { question: 'Is your current homelessness in any way caused by a relationship that broke down, an unhealthy or abusive relationship, or because family or friends caused you to become evicted?', type: 'dropdown', answers: 'general' }
  ]
});
